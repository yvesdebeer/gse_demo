...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-tq96mv6ym7j">Show
  modal</button>

<div data-modal id="modal-tq96mv6ym7j" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-tq96mv6ym7j-label" aria-describedby="modal-tq96mv6ym7j-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tq96mv6ym7j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tq96mv6ym7j-heading">Modal heading</p>
