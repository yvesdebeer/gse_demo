...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-9tvnioeneo4">Show
  modal</button>

<div data-modal id="modal-9tvnioeneo4" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-9tvnioeneo4-label" aria-describedby="modal-9tvnioeneo4-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-9tvnioeneo4-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-9tvnioeneo4-heading">Modal heading</p>
