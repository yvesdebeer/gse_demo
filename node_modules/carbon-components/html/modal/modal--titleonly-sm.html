...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-64lmr3hy8rf">Show
  modal</button>

<div data-modal id="modal-64lmr3hy8rf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-64lmr3hy8rf-label" aria-describedby="modal-64lmr3hy8rf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-64lmr3hy8rf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-64lmr3hy8rf-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
