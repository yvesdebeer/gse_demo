...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-3mraqyjkiow">Show
  modal</button>

<div data-modal id="modal-3mraqyjkiow" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-3mraqyjkiow-label" aria-describedby="modal-3mraqyjkiow-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-3mraqyjkiow-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-3mraqyjkiow-heading">Modal heading</p>
