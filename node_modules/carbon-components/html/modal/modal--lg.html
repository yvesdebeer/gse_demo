...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nc43sx12oea">Show
  modal</button>

<div data-modal id="modal-nc43sx12oea" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nc43sx12oea-label" aria-describedby="modal-nc43sx12oea-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nc43sx12oea-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nc43sx12oea-heading">Modal heading</p>
