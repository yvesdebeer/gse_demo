...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rgkct961aaa">Show
  modal</button>

<div data-modal id="modal-rgkct961aaa" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rgkct961aaa-label" aria-describedby="modal-rgkct961aaa-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rgkct961aaa-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rgkct961aaa-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-rgkct961aaa" class="bx--label">Text Input label</label>
        <input id="text-input-rgkct961aaa" type="text" class="bx--text-input" placeholder="Optional placeholder text"
