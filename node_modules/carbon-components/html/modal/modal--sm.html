...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bai104hu5m">Show
  modal</button>

<div data-modal id="modal-bai104hu5m" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bai104hu5m-label" aria-describedby="modal-bai104hu5m-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bai104hu5m-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bai104hu5m-heading">Modal heading</p>
