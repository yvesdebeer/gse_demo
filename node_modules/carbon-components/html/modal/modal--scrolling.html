...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2gzih45gicn">Show
  modal</button>

<div data-modal id="modal-2gzih45gicn" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2gzih45gicn-label" aria-describedby="modal-2gzih45gicn-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2gzih45gicn-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2gzih45gicn-heading">Modal heading</p>
