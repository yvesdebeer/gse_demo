...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-fwv0ucxylmh">Show
  modal</button>

<div data-modal id="modal-fwv0ucxylmh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-fwv0ucxylmh-label" aria-describedby="modal-fwv0ucxylmh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-fwv0ucxylmh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-fwv0ucxylmh-heading">Modal heading</p>
