...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-pfnvwhk7xel">Show
  modal</button>

<div data-modal id="modal-pfnvwhk7xel" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-pfnvwhk7xel-label" aria-describedby="modal-pfnvwhk7xel-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-pfnvwhk7xel-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-pfnvwhk7xel-heading">Modal heading</p>
