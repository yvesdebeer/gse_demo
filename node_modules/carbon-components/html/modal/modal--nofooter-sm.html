...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-tshxx2m8vqe">Show
  modal</button>

<div data-modal id="modal-tshxx2m8vqe" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-tshxx2m8vqe-label" aria-describedby="modal-tshxx2m8vqe-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-tshxx2m8vqe-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-tshxx2m8vqe-heading">Modal heading</p>
