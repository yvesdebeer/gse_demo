...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xhp96u0roi8">Show
  modal</button>

<div data-modal id="modal-xhp96u0roi8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xhp96u0roi8-label" aria-describedby="modal-xhp96u0roi8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xhp96u0roi8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xhp96u0roi8-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
