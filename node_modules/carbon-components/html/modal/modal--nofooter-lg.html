...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ap8ni4fhh0c">Show
  modal</button>

<div data-modal id="modal-ap8ni4fhh0c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ap8ni4fhh0c-label" aria-describedby="modal-ap8ni4fhh0c-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ap8ni4fhh0c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ap8ni4fhh0c-heading">Modal heading</p>
